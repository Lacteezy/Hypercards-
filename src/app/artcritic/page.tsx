...
export default function ArtcriticPage() {
  ...
  async function handleCreate() {
    ...
    const critique = await getGroqCompletion(
      `The player made an excuse described as follows: ${description}`,
      64,
      "story telling for excuses"
    );

    setMessage("Scoring excuse");
    //generate a score
    const score = await getGroqCompletion(
      `The player made an excuse described as follows: ${description}. It was critiqued as follows: ${critique}`,
      4,
      "Give the excuse a score out of 10. Do not output any other text or explanation."
    );
